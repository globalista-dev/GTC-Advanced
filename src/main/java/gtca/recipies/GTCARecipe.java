...
public class GTCARecipe {
    ...
    public static void addMacerator()
    {
        ...
        TileEntityMacerator.addRecipe(GTMaterialGen.get(GTCABlock.oreMolybdenite, 1), GTCXMaterialGen.getCrushedOre(GTCAMaterial.Molybdenite, 1));
        TileEntityMacerator.addRecipe(GTCXMaterialGen.getCrushedOre(GTCAMaterial.Molybdenite, 1), 1, GTMaterialGen.getDust(GTCAMaterial.Molybdenite, 1));
        TileEntityMacerator.addRecipe(GTCXMaterialGen.getPurifiedCrushedOre(GTCAMaterial.Molybdenite, 1), GTMaterialGen.getDust(GTCAMaterial.Molybdenite, 2));
