...
public class GTCAMaterial {
    ...
    static GTMaterialFlag[] complexOre = {DUST, smalldust, crushedore, crushedorePurified, tinydust};
    ...
    public static final GTMaterial Gadolinite = new GTMaterial("Gadolinite", 230, 0, 0, complexOre);
    public static final GTMaterial Molybdenite = new GTMaterial("Molybdenite", 102, 102, 153, complexOre);
